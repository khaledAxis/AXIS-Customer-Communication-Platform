# AGENTS.md — AXIS Customer Communication Platform

> Operating manual for Codex sessions on this repository.
...
- **Do not silently rewrite architecture.** A structural or dependency change needs an ADR and a
  AGENTS.md/doc update in the same change.
...
**same change**: `AGENTS.md` for rules, `docs/architecture.md` for structure, `docs/requirements.md`
